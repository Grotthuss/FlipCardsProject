...
public class IntegrationTests : IDisposable
{
    ...
    public async Task GetFlipcardSetByIdAsync_ReturnsCorrectFlipcardSet()
    {
        ...
        set = await _repository.GetFlipcardSetByIdAsync(2);
        ...
        {
            var card = new Flipcard("4","4","4", new FlipcardState());

            await _repository.AddFlipcardAsync(2, card);
            
            var set = await _repository.GetFlipcardSetByIdAsync(2);
        ...
        public async Task UpdateFlipcardAsync_UpdatesCardCorrectly()
        {
            ...
            await _repository.UpdateFlipcardAsync(2, card);
        ...
        public async Task UpdateFlipcardSetAsync_UpdatesSetCorrectly()
        {
            ...
            var updatedSet = await _repository.GetFlipcardSetByIdAsync(2);
        ...
        {
            int SetCountBeforeDeletion = (await _repository.GetAllFlipcardSetsAsync()).Count();
            await _repository.DeleteFlipcardSetAsync(2);
            
            int SetCountAfterDeletion = (await _repository.GetAllFlipcardSetsAsync()).Count();
        ...
        {
            int CardCountBeforeDeletion = (await _repository.GetFlipcardSetByIdAsync(2)).FlipcardsList.Count();
            
            await _repository.DeleteFlipcardAsync(2, 4);

            var affectedSet = await _repository.GetFlipcardSetByIdAsync(2);
